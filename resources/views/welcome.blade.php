...
<head>
	...
	<link href="../css2?family=Inter:wght@400;700&family=Source+Serif+Pro:wght@400;700&display=swap" rel="stylesheet">
	...
	<div class="hero">
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-lg-5">
					<div class="slides">
						<img src="{{ asset('assets/images/hero-slider-1.jpg') }}" alt="Image" class="img-fluid active">
						<img src="{{ asset('assets/images/hero-slider-2.jpg') }}"  class="img-fluid">
						<img src="{{ asset('assets/images/hero-slider-1.jpg') }}"  class="img-fluid">
						<img src="{{ asset('assets/images/hero-slider-1.jpg') }}"  class="img-fluid">
	...
	<div class="untree_co-section">
		<div class="container">
			...
			<div class="owl-carousel owl-3-slider">
				...
				<div class="item">
					<a class="media-thumb" href="{{ asset('assets/images/hero-slider-3.jpg') }}" data-fancybox="gallery">
						<div class="media-text">
